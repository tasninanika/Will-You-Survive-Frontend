...
const FormStep1 = ({ onNext }) => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 md:mt-5 p-4 md:px-8 md:py-6 bg-white/10 backdrop-blur-lg rounded-2xl shadow-xl text-center border border-white/20 w-[90%]">
